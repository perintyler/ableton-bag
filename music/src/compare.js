import { analyzeTimbre } from './analyze.js';
 ...
 */
function energyToDB(sourceEnergy, targetEnergy) {
 ...
 */
function buildBandRecommendations(source, target) {
 ...
 */
export function suggestMacroValues(source, target) {
 ...
 */
export async function spectralCorrectionCurve(sourceFile, targetFile, options) {
 ...
 */
export async function compareTimbre(sourceFile, targetFile, options) {
